...
[仓库](https://github.com/shanye1402-hash/imgapi-examples) · [官网 imgapi.vip](https://imgapi.vip/) · [接入文档](https://imgapi.vip/api-docs)
...
>
> [GitHub 仓库](https://github.com/shanye1402-hash/imgapi-examples) · [imgAPI 官网](https://imgapi.vip/)

这段是介绍草稿，不包含“亲测稳定”“免费生图”等未验证声明。收到赞助、赠送积分或其他合作支持时，按实际情况说明。仓库不承诺合作费用、免费额度或宣传效果。

## 素材与合作入口

目前可引用的素材是仓库说明、运行命令和自己的真实演示。新的场景可通过 [场景请求](https://github.com/shanye1402-hash/imgapi-examples/issues/new?template=example_request.yml) 提出，完成接入后可通过 [使用案例](https://github.com/shanye1402-hash/imgapi-examples/issues/new?template=showcase.yml) 分享。私人合作条款与凭据不要发到公开 Issue。
